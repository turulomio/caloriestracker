...
class ProductInElaboratedProductManager(QObject, ObjectManager_With_IdDatetime_Selectable):
    ...
    def qtablewidget(self, wdg):        
        ...
        wdg.table.setHorizontalHeaderItem(0, QTableWidgetItem(self.tr("Name")))
        wdg.table.setHorizontalHeaderItem(1, QTableWidgetItem(self.tr("Grams")))
        wdg.table.setHorizontalHeaderItem(2, QTableWidgetItem(self.tr("Calories")))
        wdg.table.setHorizontalHeaderItem(3, QTableWidgetItem(self.tr("Carbohydrates")))
        wdg.table.setHorizontalHeaderItem(4, QTableWidgetItem(self.tr("Protein")))
        wdg.table.setHorizontalHeaderItem(5, QTableWidgetItem(self.tr("Fat")))
        wdg.table.setHorizontalHeaderItem(6, QTableWidgetItem(self.tr("Fiber")))
