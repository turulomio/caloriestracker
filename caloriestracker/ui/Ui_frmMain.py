...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/caloriestracker/keko.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionElaboratedProductAdd.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/caloriestracker/bank.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCompaniesAdd.setIcon(icon13)
        self.actionCompaniesAdd.setObjectName("actionCompaniesAdd")
        self.actionCompanies = QtWidgets.QAction(frmMain)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/caloriestracker/companies.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCompanies.setIcon(icon14)
        ...
        self.tbMain.addAction(self.actionElaboratedProductAdd)
