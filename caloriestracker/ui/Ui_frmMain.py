...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/caloriestracker/cooking.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/caloriestracker/meals.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/caloriestracker/keko.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionElaboratedProductAdd.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/caloriestracker/company.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCompanies.setIcon(icon12)
        self.actionCompanies.setObjectName("actionCompanies")
        self.actionUsers = QtWidgets.QAction(frmMain)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/caloriestracker/users.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUsers.setIcon(icon13)
        self.actionUsers.setObjectName("actionUsers")
        self.actionReportIssue = QtWidgets.QAction(frmMain)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/caloriestracker/alarm_clock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReportIssue.setIcon(icon14)
        self.actionReportIssue.setObjectName("actionReportIssue")
        self.actionMealsMost = QtWidgets.QAction(frmMain)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/caloriestracker/crown.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMealsMost.setIcon(icon15)
        self.actionMealsMost.setObjectName("actionMealsMost")
        self.actionUserCurrent = QtWidgets.QAction(frmMain)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/caloriestracker/user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUserCurrent.setIcon(icon16)
        self.actionUserCurrent.setObjectName("actionUserCurrent")
        ...
        self.menuUsers.addAction(self.actionUserCurrent)
        ...
        self.tbUsers.addAction(self.actionUserCurrent)
    ...
    def retranslateUi(self, frmMain):
        ...
        self.actionUserCurrent.setText(_translate("frmMain", "Current user"))
        self.actionUserCurrent.setToolTip(_translate("frmMain", "Current user"))
