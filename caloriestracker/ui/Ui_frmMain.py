...
class Ui_frmMain(object):
    def setupUi(self, frmMain):
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/caloriestracker/keko.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionElaboratedProducts.setIcon(icon7)
        ...
        self.actionElaboratedProductAdd.setIcon(icon7)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/caloriestracker/bank.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCompaniesAdd.setIcon(icon12)
        self.actionCompaniesAdd.setObjectName("actionCompaniesAdd")
        self.actionCompanies = QtWidgets.QAction(frmMain)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/caloriestracker/companies.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCompanies.setIcon(icon13)
