...
class MemConsole(Mem):
    ...
    def parse_arguments(self):
        ...
        group.add_argument('--update_after_collaboration',  help=self.tr("Converts data from personal database to system after collaboration"),  action="store", default=None)
